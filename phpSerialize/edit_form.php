...
#dis{
    ...
    <table class='table table-bordered'>
        ...
        <tr>
            <td>Employee Name</td>
            <td><input type='text' name='emp_name' class='form-control' value='<?php echo unserialize($row['emp_name']); ?>' required></td>
        </tr>
 
        <tr>
            <td>Employee Department</td>
            <td><input type='text' name='emp_dept' class='form-control' value='<?php echo unserialize($row['emp_dept']); ?>' required></td>
        </tr>
