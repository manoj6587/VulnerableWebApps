...
<title>Client Side Template Injection</title>
  ...
  <script src="/Client_Side_Injection_Angular/True_Positives/Case7_Wrapped_In_SingleQuotes/angularjs/1.3.0/angular.js"></script>
           ...
           <div class="col-sm-offset-3 col-sm-8">
            ...
            <%
             ...
             if(search!=null){
                 ...
                 out.println("You are search: <a href='"+results+"'>Check More</a>");
