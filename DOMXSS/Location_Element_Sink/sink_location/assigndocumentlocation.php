...
<p>In comment box user will add new url which will assign to document.location object. In comment box please provide following vulnerable link for exploid. "http://www.google.com?name=&lt;script&gt;alert('qxss')&lt;/script&gt;"</p>
...
function fruitFunction() {
     ...
     document.location = decodeURIComponent(jtext);
